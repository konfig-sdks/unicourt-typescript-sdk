...
/**
 * This class provides a wrapper for network errors when making requests to UniCourt Enterprise APIs
 */
export class UniCourtError extends Error {
  /**
   * The response body
   */
