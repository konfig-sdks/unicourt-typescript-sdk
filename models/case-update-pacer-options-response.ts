...
import { CaseUpdatePacerOptionsResponseAdditionalPageArrayInner } from './case-update-pacer-options-response-additional-page-array-inner';

/**
 * Applicable for PACER cases.
 * @export
 * @interface CaseUpdatePacerOptionsResponse
 */
export interface CaseUpdatePacerOptionsResponse {
     ...
     * @type {Array<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner>}
     * @memberof CaseUpdatePacerOptionsResponse
     */
    'additionalPageArray': Array<CaseUpdatePacerOptionsResponseAdditionalPageArrayInner> | null;
    /**
     ...
     * @memberof CaseUpdatePacerOptionsResponse
     */
    'refreshType': CaseUpdatePacerOptionsResponseRefreshTypeEnum;
}

type CaseUpdatePacerOptionsResponseRefreshTypeEnum = 'fetchNewDocketEntries' | 'fetchAllDocketEntries'
