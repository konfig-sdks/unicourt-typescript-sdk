 ...
 * 
 * @export
 * @interface CaseUpdatePacerOptionsAdditionalPageArrayInner
 */
export interface CaseUpdatePacerOptionsAdditionalPageArrayInner {
    /**
     ...
     * @type {number}
     * @memberof CaseUpdatePacerOptionsAdditionalPageArrayInner
     */
     ...
     * @memberof CaseUpdatePacerOptionsAdditionalPageArrayInner
     */
    'page'?: CaseUpdatePacerOptionsAdditionalPageArrayInnerPageEnum;
}

type CaseUpdatePacerOptionsAdditionalPageArrayInnerPageEnum = 'associatedCases' | 'caseSummary' | 'listOfCreditors'
